...
add-apt-repository -y ppa:tobhe/mesa-test

apt-get update
apt-get upgrade -y
apt-get install -y libgl1 libgl1:i386 mesa-vulkan-drivers libglx-mesa0 libgl1-mesa-dri \
    libegl-mesa0
...
apt-get install -y \
  ...
  mesa-libgallium mesa-libgallium:i386 mesa-vulkan-drivers \
